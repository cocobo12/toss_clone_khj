...
const DUMMY_BANKBOOK = [
  ...
  new BankBook("모임", "토스뱅크에 쌓인 이자", "원", "35", false),
  new BankBook("증권", "토스뱅크에 쌓인 이자", "원", "30", false),
  new BankBook("외화", "토스뱅크에 쌓인 이자", "원", "0", false),
  new BankBook("토스", "토스뱅크에 쌓인 이자", "원", "3,830", false),
  new BankBook("토스", "저축예금", "원", "100", true),
